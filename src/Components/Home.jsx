              ...
              <Col lg={6} md={12} sm={12}>
                <div className="Home_Left">
                  <div className="Home_Left_Txt1">
                    ...
                    <br />
                    This is
                    <span className=""style={{ color: "#E60076" }}> KAVIN KUMAR</span> , I'm
                    a Professional
                  ...
                  <div className="card">
                    ...
                    <div className="card__content">
                      <div className="Home_card_txt">
                        <div><span style={{color : "#e60076"}}>const</span> Developer<span style={{color : "#e60076"}}> = </span>{"{"}</div>
                        <div className="Home_card_txt1">
                          ...
                          <div className="">skills:[
                            <div className="Home_card_txt1">'<span className="yellow_code_txt">Java</span>','<span className="yellow_code_txt">HTML</span>', '<span className="yellow_code_txt">CSS</span>', '<span className="yellow_code_txt">JavaScript</span>', '<span className="yellow_code_txt">React</span>', '<span className="yellow_code_txt">NodeJS</span>', '<span className="yellow_code_txt">Express</span>', '<span className="yellow_code_txt">MangoDB</span>', '<span className="yellow_code_txt">MySql</span>'</div>
                            ],</div>
                          ...
                          <div className=""><span className="green_code_txt">hireable: </span><span className="orrange_code_txt">function</span>() {"{"} </div>
                          <div className="Home_card_txt1">
